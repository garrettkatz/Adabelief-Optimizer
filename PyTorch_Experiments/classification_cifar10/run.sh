...
# original decay epoch with no independence overwork
# other control: adabelief with cap in original LR schedule
CUDA_VISIBLE_DEVICES=0 python3 main.py --classes 10 --model resnet --optim abcapi --lr 1e-3 --eps 1e-8 --beta1 0.9 --beta2 0.999 --momentum 0.9 --weight_decay 0.0005 --decay_epoch 150 --total_epoch 200
